...
# 单体化后所有迁移脚本集中在单一模块 moyue-app（原 moyue-common-migration 已并入）
MIGRATION_DIR = ROOT / "moyue-app" / "src" / "main" / "resources" / "db" / "migration"

# 输出目标：单体后仅 moyue-app 一个模块需要跑 DB 集成测试
OUTPUT_MODULES = [
    "moyue-app",
]
